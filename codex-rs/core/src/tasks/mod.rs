...
impl Session {
    ...
    pub(crate) async fn start_task<T: SessionTask>(
        ...
        // SANDBOX PATCH: wrap upstream's input_queue.take_queued_response_items_for_next_turn
        // with coalesce_background_notifications so background-job tool results dedup before
        // re-entering the turn loop.
