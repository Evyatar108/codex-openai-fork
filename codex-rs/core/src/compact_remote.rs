...
async fn run_remote_compact_task_inner(
    ...
    if turn_context.provider.info().is_copilot() {
        // SANDBOX PATCH: TODO(copilot-v7): translate /compact schema.
        // Copilot Responses API does not implement the upstream /compact RPC; the
        // upstream call would 404 and burn a turn. Skip until v7 translates the
        // schema. See patch-surface.md §1 for the Copilot transport invariant.
        return Ok(());
    }
