...
impl Session {
    ...
    pub(crate) fn build_per_turn_config(
        ...
        per_turn_config.model_context_tier = session_configuration.model_context_tier;
    ...
    pub(crate) fn make_turn_context(
        ...
        // SANDBOX PATCH: P9 — fork-only TurnContext.user_shell_type. Bind once and reuse
        // for both UnifiedExecShellMode::for_session and the struct field below.
