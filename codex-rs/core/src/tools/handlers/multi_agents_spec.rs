...
fn spawn_agent_tool_description(
    ...
    let tool_description = format!(
        r#"
        {agent_role_guidance}
        Spawn a sub-agent for a well-scoped task. {return_value_description} {inherited_model_guidance} Spawned agents remain open and reusable after completion until close_agent closes them."#
    );
...
It will be able to send you and other running agents messages, and its final answer will be provided to you when it finishes. Finished agents remain open and reusable until interrupt_agent closes them.
