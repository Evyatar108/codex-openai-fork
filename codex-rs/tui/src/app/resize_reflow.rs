...
impl App {
    ...
    // SANDBOX PATCH: TerminalResizeReflow feature gate retired (upstream #27794 made reflow
    // always-on, Stage::Removed). RetainedTranscriptViewport remains a separate fork-owned gate.
