...
pub enum UpdateAction {
    /// Update via `npm install -g @gim-home/codex@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @gim-home/codex@latest`.
    BunGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@gim-home/codex"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "@gim-home/codex"]),
